...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function initializeMainApp() {
        ...
        // *** ESTAS SÃO AS LINHAS QUE ESTAVAM QUEBRANDO O APP ***
    ...
    function openDemandaModal(cidadaoId = null) {
        ...
        const filterOptions = () => {
            ...
            for (let i = 0; i < options.length; i++) {
                ...
                if (option.value === "") {
                    // Garante que a opção "Selecione..." esteja sempre visível
    ...
    // *** INÍCIO DA CORREÇÃO ***
    // As funções foram movidas para fora de 'openDemandaModal'
