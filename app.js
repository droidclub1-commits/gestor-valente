...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function initializeMainApp() {
        ...
        // [NOVA ALTERAÇÃO] - Capturar a logo
        ...
        // [NOVA ALTERAÇÃO] - Adicionar evento de clique na logo
        if (logoBtn) {
        ...
        // [NOVA FUNÇÃO] - Isola a lógica de filtragem
        function getFilteredCidadaos() {
            ...
            // [FIM DA ALTERAÇÃO]
            return filteredCidadaos;
        }

        function renderCidadaos() {
            // [ALTERAÇÃO] - Usa a nova função de filtragem
        ...
        generateReportBtn.addEventListener('click', () => {
            // [ALTERAÇÃO] - Pega os dados filtrados
            const dataToPrint = getFilteredCidadaos();

            if (dataToPrint.length === 0) {
                showToast('Nenhum cidadão encontrado com os filtros para gerar o relatório.', 'info');
                return;
            }

            generatePrintReport(dataToPrint);
