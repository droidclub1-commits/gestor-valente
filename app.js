...
let logoBtn, logoutBtn, sidebarNav, addCidadaoBtn, addDemandaGeralBtn,
    ...
    cidadaosBairroChart = null, cidadaosSexoChart = null, cidadaosFaixaEtariaChart = null; // FINALIZADO COM PONTO-E-VÍRGULA IMPLÍCITO OU EXPLÍCITO
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function initializeMainApp() {
        ...
        // NOVO: Verifica se os elementos essenciais foram carregados
        if (!logoutBtn || !cidadaoForm) {
            console.error("Erro ao carregar elementos da UI. Tentando novamente.");
            appInitialized = false; // Permite uma nova tentativa
            return; 
        }

        appInitialized = true; // Só define como true se a captura foi bem-sucedida
