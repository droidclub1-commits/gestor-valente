...
// A SUPABASE_SERVICE_ROLE FOI REMOVIDA DO CÓDIGO POR SEGURANÇA.

const { createClient } = supabase;
let sb, user = null; // Removido sbService

try {
    // Cliente Público (sb): USADO PARA AUTH, CRUD RESTRITO E LEITURA (AGORA QUE O RLS ESTÁ CORRETO)
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    try {
        // AGORA USAMOS O CLIENTE PÚBLICO (sb) e o RLS SE ENCARREGA DA SEGURANÇA
