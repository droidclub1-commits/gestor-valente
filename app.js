...
try {
    ...
    // Cliente de Serviço (sbService): CORREÇÃO FINAL - Usa chave de storage ÚNICA.
    // Isso impede que o cliente de serviço toque no token de sessão do usuário principal, eliminando o erro.
    sbService = createClient(SUPABASE_URL, SUPABASE_SERVICE_ROLE, {
        auth: {
            ...
            storage: { // Usa um objeto de armazenamento dummy/nulo
                getItem: () => null, 
                setItem: () => {}, 
                removeItem: () => {}
            }
