...
document.addEventListener('DOMContentLoaded', () => {
    ...
    sb.auth.onAuthStateChange((event, session) => {
        if (session && session.user) {
            user = session.user;
            // Não inicializa aqui — manageSessionOnLoad é a única entrada
    ...
    async function initializeMainApp() {
        ...
        // Reseta todo o estado antes de carregar — evita dados de sessão anterior
        ...
        logoutBtn.addEventListener('click', async () => {
            try {
                ...
                // onAuthStateChange trata o reset e o redirecionamento
            } catch (error) {
